  ...
  const consultantsData = [
    {
      ...
      email: "info@levmoraservices.com",
    ...
    },
    {
      ...
      email: "info@emergingafricagroup.com",
      phone: "+234 XXX XXX XXXX"
    }
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div 
            ref={consultantsRef}
            className="flex items-center justify-center flex-col gap-12 max-w-6xl mx-auto"
          >
            {consultantsData.map((consultant) => (
              ...
              >
                ...
                <div className="p-8">
                  {/* Title */}
                  <h3 className="text-2xl font-bold text-[#0B3D2E] mb-6 text-center">
                    {consultant.title}
                  </h3>
