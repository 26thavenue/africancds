export const vendorTicketConfirmedEmail = {
  ...
  html: `
    ...
    <p>
      You are now officially confirmed as a vendor for the African Chiefs of Defense Staff (ACDS) Summit 2025.
    </p>
    <p>
      Event logistics and further participation details will be sent to you shortly.
    </p>
    <p>
      Thank you for being a part of this important gathering. We look forward to seeing you at the summit.
    </p>
    <p>Sincerely,<br/>ACDS Summit Team</p>
  `,
};
